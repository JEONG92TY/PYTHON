...
while True :
    ...
    if user == "소비자" :
        print("소비자 로그인")
        check_machine() #print(f"현재 리스트 : {vending_machine}")
        while True :
            while True :
                ...
                if bev == "종료" :
                    ...
                    check_machine() #print(f"남은 음료수 : {vending_machine}")
                else :
            ...
            if do == "종료" :
                ...
                while True :
                    if add == "취소" :
                        ...
                        print("추가 완료")
                        check_machine() #print(f"변경된 리스트 : {vending_machine}")
                        break
            elif do == "삭제" :
